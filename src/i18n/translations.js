...
// ── Price Comparer v2 keys (affiliate system) ────────────────────────────────
translations.en.price_best_from      = 'Best from';
translations.en.price_best_deal      = 'Best Deal';
translations.en.price_results_for    = 'Results for';
translations.en.price_stores         = 'stores';
translations.en.price_disclosure     = 'Some links are affiliate links. We may earn a commission when you purchase — at no extra cost to you.';
translations.en.price_disclaimer     = 'Prices are estimates. Verify current prices on the store website before purchasing.';
translations.en.price_free_shipping  = 'Free Shipping';
translations.en.price_in_stock       = 'In Stock';
translations.en.price_out_of_stock   = 'Out of Stock';
translations.en.price_shop_now       = 'Shop Now';
translations.en.price_popular        = 'Popular Medications';
translations.en.price_recent         = 'Recent Searches';

translations.tr.price_best_from      = 'En düşük';
translations.tr.price_best_deal      = 'En İyi Fiyat';
translations.tr.price_results_for    = 'Sonuçlar:';
translations.tr.price_stores         = 'mağaza';
translations.tr.price_disclosure     = 'Bazı bağlantılar ortaklık bağlantısıdır. Satın alma yapıldığında komisyon kazanabiliriz — size ekstra maliyet yok.';
translations.tr.price_disclaimer     = '* Fiyatlar tahminidir. Satın almadan önce mağaza sitesinde güncel fiyatları doğrulayın.';
translations.tr.price_free_shipping  = 'Ücretsiz Kargo';
translations.tr.price_in_stock       = 'Stokta Var';
translations.tr.price_out_of_stock   = 'Stokta Yok';
translations.tr.price_shop_now       = 'Satın Al';
translations.tr.price_popular        = 'Popüler İlaçlar';
translations.tr.price_recent         = 'Son Aramalar';

translations.de.price_best_from      = 'Ab';
translations.de.price_best_deal      = 'Bestes Angebot';
translations.de.price_results_for    = 'Ergebnisse für';
translations.de.price_stores         = 'Shops';
translations.de.price_disclosure     = 'Einige Links sind Affiliate-Links. Wir können eine Provision erhalten — ohne Mehrkosten für Sie.';
translations.de.price_disclaimer     = '* Preise sind Schätzungen. Bitte aktuelle Preise vor dem Kauf prüfen.';
translations.de.price_free_shipping  = 'Kostenloser Versand';
translations.de.price_in_stock       = 'Auf Lager';
translations.de.price_out_of_stock   = 'Nicht verfügbar';
translations.de.price_shop_now       = 'Jetzt kaufen';
translations.de.price_popular        = 'Beliebte Medikamente';
translations.de.price_recent         = 'Letzte Suchen';

translations.fr.price_best_from      = 'Dès';
translations.fr.price_best_deal      = 'Meilleure Offre';
translations.fr.price_results_for    = 'Résultats pour';
translations.fr.price_stores         = 'boutiques';
translations.fr.price_disclosure     = 'Certains liens sont affiliés. Nous pouvons recevoir une commission — sans coût supplémentaire pour vous.';
translations.fr.price_disclaimer     = "* Les prix sont des estimations. Vérifiez les prix actuels avant d'acheter.";
translations.fr.price_free_shipping  = 'Livraison gratuite';
translations.fr.price_in_stock       = 'En stock';
translations.fr.price_out_of_stock   = 'Rupture de stock';
translations.fr.price_shop_now       = 'Acheter';
translations.fr.price_popular        = 'Médicaments populaires';
translations.fr.price_recent         = 'Recherches récentes';

translations.ar.price_best_from      = 'ابتداءً من';
translations.ar.price_best_deal      = 'أفضل صفقة';
translations.ar.price_results_for    = 'نتائج لـ';
translations.ar.price_stores         = 'متاجر';
translations.ar.price_disclosure     = 'بعض الروابط هي روابط تابعة. قد نحصل على عمولة عند الشراء — بدون تكلفة إضافية عليك.';
translations.ar.price_disclaimer     = '* الأسعار تقديرية. تحقق من الأسعار الحالية قبل الشراء.';
translations.ar.price_free_shipping  = 'شحن مجاني';
translations.ar.price_in_stock       = 'متوفر';
translations.ar.price_out_of_stock   = 'غير متوفر';
translations.ar.price_shop_now       = 'تسوق الآن';
translations.ar.price_popular        = 'الأدوية الشائعة';
translations.ar.price_recent         = 'عمليات البحث الأخيرة';
